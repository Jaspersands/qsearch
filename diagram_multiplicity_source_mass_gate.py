...
def write_diagram_multiplicity_source_mass_gate(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG-AM-MULTIPLICITY-SOURCE-MASS-GATE",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-DIAGRAM-MULTIPLICITY-SOURCE-MASS-GATE."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-DIAGRAM-MULTIPLICITY-SOURCE-MASS-GATE."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "diagram_multiplicity_source_mass_gate": str(path)
                },
            )
        )
