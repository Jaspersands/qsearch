...
def write_coset_hyperoctahedral_branching_polar_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG--HYPEROCTAHEDRAL-BRANCHING-POLAR-BOUNDARY",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-COSET-HYPEROCTAHEDRAL-BRANCHING-POLAR-BOUNDARY."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-COSET-HYPEROCTAHEDRAL-BRANCHING-POLAR-BOUNDARY."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "coset_hyperoctahedral_branching_polar_boundary": str(output_path)
                },
            )
        )
