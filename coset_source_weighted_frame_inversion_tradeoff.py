...
def write_coset_source_weighted_frame_inversion_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG--SOURCE-WEIGHTED-FRAME-INVERSION-TRADEOFF",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-COSET-SOURCE-WEIGHTED-FRAME-INVERSION-TRADEOFF."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-COSET-SOURCE-WEIGHTED-FRAME-INVERSION-TRADEOFF."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "coset_source_weighted_frame_inversion_tradeoff": str(output_path)
                },
            )
        )
