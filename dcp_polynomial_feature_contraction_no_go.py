...
def write_polynomial_feature_contraction_no_go(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG-CP-POLYNOMIAL-FEATURE-CONTRACTION-NO-GO",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-DHS-DCP-POLYNOMIAL-FEATURE-CONTRACTION-NO-GO."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-DHS-DCP-POLYNOMIAL-FEATURE-CONTRACTION-NO-GO."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "dcp_polynomial_feature_contraction_no_go": str(path)
                },
            )
        )
