...
def write_support_filter_no_go_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG--HIDDEN-INVOLUTION-SUPPORT-FILTER-NO-GO",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-COSET-HIDDEN-INVOLUTION-SUPPORT-FILTER-NO-GO."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-COSET-HIDDEN-INVOLUTION-SUPPORT-FILTER-NO-GO."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "coset_hidden_involution_support_filter_no_go": str(output_path)
                },
            )
        )
