...
def write_arbitrary_measurement_witness_reduction_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG-CP-ARBITRARY-MEASUREMENT-WITNESS-REDUCTION",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-DHS-DCP-ARBITRARY-MEASUREMENT-WITNESS-REDUCTION."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-DHS-DCP-ARBITRARY-MEASUREMENT-WITNESS-REDUCTION."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "dcp_arbitrary_measurement_witness_reduction": str(path)
                },
            )
        )
