...
def write_dcp_varying_hms_fiber_normal_form(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG-CP-VARYING-HMS-FIBER-NORMAL-FORM",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-DHS-DCP-VARYING-HMS-FIBER-NORMAL-FORM."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-DHS-DCP-VARYING-HMS-FIBER-NORMAL-FORM."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "dcp_varying_hms_fiber_normal_form": str(path)
                },
            )
        )
