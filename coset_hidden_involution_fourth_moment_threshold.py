...
def write_hidden_involution_fourth_moment_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG--HIDDEN-INVOLUTION-FOURTH-MOMENT-THRESHOLD",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-COSET-HIDDEN-INVOLUTION-FOURTH-MOMENT-THRESHOLD."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-COSET-HIDDEN-INVOLUTION-FOURTH-MOMENT-THRESHOLD."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "coset_hidden_involution_fourth_moment_threshold": str(path)
                },
            )
        )
    ...
    if write_registry:
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                falsifiers_triggered=_res_payload.get("falsifiers_triggered", []),
                artifacts={
                    "coset_hidden_involution_fourth_moment_threshold": str(output_path)
                },
            )
        )
