...
def write_affine_star_channel_gap_report(
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG-SELF-DUAL-WREATH-AFFINE-STAR-CHANNEL-GAP",
                source=registry_experiment_id,
                claim=(
                    "Naive initial assumption for EXP-CODE-SELF-DUAL-WREATH-AFFINE-STAR-CHANNEL-GAP."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-CODE-SELF-DUAL-WREATH-AFFINE-STAR-CHANNEL-GAP."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "self_dual_wreath_affine_star_channel_gap": str(path)
                },
            )
        )
    return payload
