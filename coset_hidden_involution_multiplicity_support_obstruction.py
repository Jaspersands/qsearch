...
def write_multiplicity_support_obstruction_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG--HIDDEN-INVOLUTION-MULTIPLICITY-SUPPORT-OBSTRUCTION",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-COSET-HIDDEN-INVOLUTION-MULTIPLICITY-SUPPORT-OBSTRUCTION."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-COSET-HIDDEN-INVOLUTION-MULTIPLICITY-SUPPORT-OBSTRUCTION."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "coset_hidden_involution_multiplicity_support_obstruction": str(path)
                },
            )
        )
    ...
    if write_registry:
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                falsifiers_triggered=_res_payload.get("falsifiers_triggered", []),
                artifacts={
                    "coset_hidden_involution_multiplicity_support_obstruction": str(output_path)
                },
            )
        )
