...
def write_pgm_bootstrap_perturbation_reduction(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG-CP-PGM-BOOTSTRAP-PERTURBATION-REDUCTION",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-DHS-DCP-PGM-BOOTSTRAP-PERTURBATION-REDUCTION."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-DHS-DCP-PGM-BOOTSTRAP-PERTURBATION-REDUCTION."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "dcp_pgm_bootstrap_perturbation_reduction": str(path)
                },
            )
        )
