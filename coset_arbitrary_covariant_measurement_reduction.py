...
def write_arbitrary_covariant_measurement_reduction(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG--ARBITRARY-COVARIANT-MEASUREMENT-REDUCTION",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-COSET-ARBITRARY-COVARIANT-MEASUREMENT-REDUCTION."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-COSET-ARBITRARY-COVARIANT-MEASUREMENT-REDUCTION."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "coset_arbitrary_covariant_measurement_reduction": str(path)
                },
            )
        )
