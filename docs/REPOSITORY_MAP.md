...
Q-Search organizes its 756 scientific theorem verification modules within a dedicated `theorems/` package, while keeping core framework engine modules in `core/` and the unified CLI at the repository root.
