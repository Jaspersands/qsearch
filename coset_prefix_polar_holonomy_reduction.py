...
def write_coset_prefix_polar_holonomy_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG--PREFIX-POLAR-HOLONOMY-REDUCTION",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-COSET-PREFIX-POLAR-HOLONOMY-REDUCTION."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-COSET-PREFIX-POLAR-HOLONOMY-REDUCTION."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "coset_prefix_polar_holonomy_reduction": str(output_path)
                },
            )
        )
