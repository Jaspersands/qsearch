...
def write_common_core_polar_bypass_report(
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG-SELF-DUAL-WREATH-COMMON-CORE-POLAR-BYPASS",
                source=registry_experiment_id,
                claim=(
                    "Naive initial assumption for EXP-CODE-SELF-DUAL-WREATH-COMMON-CORE-POLAR-BYPASS."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-CODE-SELF-DUAL-WREATH-COMMON-CORE-POLAR-BYPASS."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "self_dual_wreath_common_core_polar_bypass": str(path)
                },
            )
        )
    return payload
