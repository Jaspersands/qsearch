...
def write_low_bit_candidate_list_no_go_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG-CP-LOW-BIT-CANDIDATE-LIST-NO-GO",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-DHS-DCP-LOW-BIT-CANDIDATE-LIST-NO-GO."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-DHS-DCP-LOW-BIT-CANDIDATE-LIST-NO-GO."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "dcp_low_bit_candidate_list_no_go": str(path)
                },
            )
        )
