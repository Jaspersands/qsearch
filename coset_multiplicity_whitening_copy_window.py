...
def write_coset_multiplicity_whitening_copy_window_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG--MULTIPLICITY-WHITENING-COPY-WINDOW",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-COSET-MULTIPLICITY-WHITENING-COPY-WINDOW."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-COSET-MULTIPLICITY-WHITENING-COPY-WINDOW."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "coset_multiplicity_whitening_copy_window": str(output_path)
                },
            )
        )
