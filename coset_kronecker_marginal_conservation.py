...
def write_kronecker_marginal_conservation_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG--KRONECKER-MARGINAL-CONSERVATION",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-COSET-KRONECKER-MARGINAL-CONSERVATION."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-COSET-KRONECKER-MARGINAL-CONSERVATION."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "coset_kronecker_marginal_conservation": str(path)
                },
            )
        )
