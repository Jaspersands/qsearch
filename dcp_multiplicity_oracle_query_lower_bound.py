...
def write_multiplicity_oracle_query_lower_bound(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG-CP-MULTIPLICITY-ORACLE-QUERY-LOWER-BOUND",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-DHS-DCP-MULTIPLICITY-ORACLE-QUERY-LOWER-BOUND."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-DHS-DCP-MULTIPLICITY-ORACLE-QUERY-LOWER-BOUND."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "dcp_multiplicity_oracle_query_lower_bound": str(path)
                },
            )
        )
