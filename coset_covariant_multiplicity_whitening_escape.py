...
def write_coset_covariant_multiplicity_whitening_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG--COVARIANT-MULTIPLICITY-WHITENING-ESCAPE",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-COSET-COVARIANT-MULTIPLICITY-WHITENING-ESCAPE."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-COSET-COVARIANT-MULTIPLICITY-WHITENING-ESCAPE."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "coset_covariant_multiplicity_whitening_escape": str(path)
                },
            )
        )
