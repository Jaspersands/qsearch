...
def write_linear_reparameterization_affine_flat_report(
    ...
    **kwargs: Any,
    ...
    if write_registry:
        ...
        upsert_negative_result(
            NegativeResultRecord(
                id="NEG-CP-LINEAR-REPARAMETERIZATION-AFFINE-FLAT-NO-GO",
                source=registry_experiment_id,
                claim=(
                    "Initial negative claim for EXP-DHS-DCP-LINEAR-REPARAMETERIZATION-AFFINE-FLAT-NO-GO."
                ),
                reason_invalid=(
                    "Falsified or refined by exact theorem evaluation."
                ),
                lesson=(
                    "Lesson from exact theorem analysis for EXP-DHS-DCP-LINEAR-REPARAMETERIZATION-AFFINE-FLAT-NO-GO."
                ),
                applies_to=[
        ...
        upsert_experiment_result(
            ExperimentResultRecord(
                ...
                artifacts={
                    "dcp_linear_reparameterization_affine_flat_no_go": str(output_path)
                },
            )
        )
